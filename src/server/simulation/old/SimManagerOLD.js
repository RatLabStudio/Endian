import * as Server from '../../serverOLD.js';
...
export function playerSimulationUpdate(newPlayers) {
...
export function movedNetworkObjects(movedObjects) {
...
export function sendRays(newRays) {
    rays = newRays;
};
